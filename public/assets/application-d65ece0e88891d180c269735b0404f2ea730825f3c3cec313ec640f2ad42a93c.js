...
(function() { this.JST || (this.JST = {}); this.JST["ratings/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h2>',  rating.escape('username') ,' rated it ',  rating.escape('rating') ,'</h2>\n<h4>',  rating.escape('created_at') ,'</h4>\n<p>',  rating.escape('body') ,'</p>\n');}return __p.join('');};
}).call(this);
