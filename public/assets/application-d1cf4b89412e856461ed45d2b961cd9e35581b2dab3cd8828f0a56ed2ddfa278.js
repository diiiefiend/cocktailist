...
(function() { this.JST || (this.JST = {}); this.JST["cocktails/_catShowBar"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="box">\n  <h1>Filter</h1>\n  <ul class="filter-list small">\n    ');  liquors.forEach(function (liquor){ ; __p.push('\n      <li><a href="javascript:void(0);" ',  target===liquor ? "class=bolded" : "" ,'>',  liquor ,'</a></li>\n    ');  }); ; __p.push('\n  </ul>\n  <p><a class="subtext" href="javascript:void(0);">Show all</a></p>\n</div>\n<div class="box">\n  <h1>Browse</h1>\n  <ul>\n    ');  bars.forEach(function (bar){ ; __p.push('\n      <li><a href="#browse/bar/',  bar ,'" ',  bar===category ? "class=bolded" : "" ,'>',  bar ,'</a></li>\n    ');  }); ; __p.push('\n  </ul>\n  <p><a class="subtext" href="#browse/liquor/switch">Browse by liquor</a></p>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["cocktails/_catShowLiquor"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="box">\n  <h1>Filter</h1>\n  <ul class="filter-list small">\n    ');  bars.forEach(function (bar){ ; __p.push('\n      <li><a href="javascript:void(0);" ',  target===bar ? "class=bolded" : "" ,'>',  bar ,'</a></li>\n    ');  }); ; __p.push('\n  </ul>\n  <p><a  class="subtext" href="javascript:void(0);">Show all</a></p>\n</div>\n<div class="box">\n  <h1>Browse</h1>\n  <ul>\n    ');  liquors.forEach(function (liquor){ ; __p.push('\n      <li><a href="#browse/liquor/',  liquor ,'" ',  liquor===category ? "class=bolded" : "" ,'>',  liquor ,'</a></li>\n    ');  }); ; __p.push('\n  </ul>\n  <p><a class="subtext" href="#browse/bar/switch">Browse by establishment</a></p>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["cocktails/_categoryShowItem"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<li title="',  cocktail.get('name') ,' @ ',  cocktail.bar().name ,'" ',  standalone ? "class='standalone'" : "" ,' >\n  <a href="#cocktails/',  cocktail.id ,'">\n  ');  if(cocktail.id && cocktail.get('cocktailPic') !== 'placeholder.png'){ ; __p.push('\n    ');  if(cocktail.get('cocktailPic').indexOf('queensparkswizzle') > -1){ ; __p.push('\n      <img src="https://s3.amazonaws.com/cocktailist-pro/cocktails/imgs/000/000/008/small/queensparkswizzle.jpg" alt="',  cocktail.get('name') ,' ',  cocktail.get('bar') ,'">\n    ');  } else { ; __p.push('\n      <img src="',  cocktail.get('cocktailPic') ,'" alt="',  cocktail.get('name') ,' ',  cocktail.get('bar') ,'">\n    ');  }; ; __p.push('\n  ');  } else { ; __p.push('\n    <img src="https://s3.amazonaws.com/cocktailist-pro/cocktails/imgs/placeholder.png" alt="',  cocktail.get('name') ,' ',  cocktail.get('bar') ,'">\n  ');  }; ; __p.push('\n  </a>\n</li>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["cocktails/_rSide"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="box">\n  <h1>',  bar.name ,'</h1>\n  <h3>',  bar.address ,'</h3>\n  <p><a href="#browse/bar/',  escape(bar.name) ,'">Browse their other offerings</a></p>\n</div>\n');  if(similarCocktail && similarCocktail !== "N/A"){ ; __p.push('\n<div class="box">\n  <h1>Similar</h1>\n    <ul class="category-show-list clearfix">\n      ',  JST['cocktails/_categoryShowItem']({cocktail: similarCocktail, standalone: true}) ,'\n    </ul>\n    <p><a href="#browse/liquor/',  similarCocktail.escape('liquor') ,'">Browse ',  similarCocktail.escape('liquor') ,' drinks</a></p>\n</div>\n');  }; ; __p.push('\n<div class="box">\n  <p>Notice something wrong? <a href="#cocktails/edit/',  cId ,'">Edit entry.</a></p>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["cocktails/catShow"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="left wide">\n  <h1 class="capitalize">',  category ,'</h1>\n  <div class="box">\n    <ul class="category-show-list clearfix">\n      ');  cocktails.forEach( function (cocktail){ ; __p.push('\n        ',  JST['cocktails/_categoryShowItem']({cocktail: cocktail, standalone: false}) ,'\n      ');  }) ; __p.push('\n    </ul>\n  </div>\n</div>\n<div class="rule-right"></div>\n<div class="right bar">\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["cocktails/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="box">\n  <h1>',  entry.isNew() ? "Add" : "Edit" ,' Cocktail Entry</h1>\n  <form class="cocktailForm">\n    <label for="cName">Name</label>\n    <input type="text" value="',  entry.escape('name') ,'" name="cocktail[name]" id="cName">\n\n    <label for="liquor">Liquor</label>\n    <a class="toggle-liquor" href="javascript:void(0);">or add new</a>\n    <select class="toggle-liquor" name="cocktail[liquor]">\n      <option value=""></option>\n      ');  liquorTypes.forEach( function (liquor){ ; __p.push('\n        <option value="',  liquor ,'" ',  entry.get('liquor')===liquor ? "selected" : "" ,' >',  liquor ,'</option>\n      ');  }); ; __p.push('\n    </select>\n    <input class="toggle-liquor" type="text" placeholder="add new liquor" id="liquor">\n\n    <label for="ingredients">Ingredients</label>\n    <input type="text" value="',  entry.escape('ingredients') ,'" name="cocktail[ingredients]" id="ingredients">\n\n    <label for="bar">Bar</label>\n    <a class="toggle-bar" href="javascript:void(0);">or add new</a>\n    <select class="toggle-bar" name="cocktail[bar_name]">\n      <option value=""></option>\n        ');  bars.forEach ( function (barName){ ; __p.push('\n        <option value="',  barName ,'"  ',  entry.bar().name===barName ? "selected" : "" ,'>',  barName ,'</option>\n      ');  }); ; __p.push('\n    </select>\n    <input class="toggle-bar" type="text" placeholder="add new bar: name" id="bar">\n    <input class="toggle-bar" type="text" placeholder="add new bar: address">\n\n    <a href="javascript: void(0);" class="remove-img"><img src="',  entry.get('cocktailPic')!== 'placeholder.png' ? entry.get('cocktailPic') : "" ,'" id="image-preview"></a>\n    <label for="image">Image (if any)</label>\n      <input type="file" name="cocktail[img]" id="attach-image">\n\n    <ul id="errors"></ul>\n    <button class="submit">Save</button>\n  </form>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["cocktails/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="left wide">\n  ');  for(group in groups){ ; __p.push('\n    <div class="box">\n      <h2>Latest in <span class="capitalize" id="browse-',  group ,'">',  group ,'</span></h2>\n      <ul class="category-show-list clearfix">\n\n        ');  for(var i = 0; i < Math.min(5, groups[group].length); i++){ ; __p.push('\n          ');  var cocktail = groups[group][i]; ; __p.push('\n          ',  JST['cocktails/_categoryShowItem']({cocktail: cocktail, standalone: false}) ,'\n        ');  }; ; __p.push('\n      </ul>\n      ');  if(groups[group].length > 5){ ; __p.push('\n        <p><a href="#browse/',  filterType ,'/',  escape(group) ,'">View more in this category</a></p>\n      ');  } ; __p.push('\n    </div>\n  ');  }; ; __p.push('\n</div>\n\n<div class="rule-right"></div>\n\n<div class="right bar">\n  <div class="box">\n    <h1>Categorize by:</h1>\n    <ul class="filter-list">\n      <li><a href="javascript: void(0);" ',  filterType==='liquor' ? "class='bolded'" : "" ,' >Liquor</a></li>\n      <li><a href="javascript: void(0);" ',  filterType==='bar' ? "class='bolded'" : "" ,' >Establishment</a></li>\n    </ul>\n  </div>\n  <div class="box">\n    <h1 class="capitalize">',  filterType ,'</h1>\n    <ul>\n      ');  list.forEach(function (listItem){ ; __p.push('\n        <li><a href="#browse-',  listItem ,'">',  listItem ,'</a></li>\n      ');  }); ; __p.push('\n    </ul>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["cocktails/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="left wide">\n  <div class="box">\n    <h1 class="header-box">',  cocktail.escape('name') ,'</h1>\n    <div class="image-placeholder">\n      ');  if(cocktail.get('img_url')){; __p.push('\n        <img src="',  cocktail.get('img_url') ,'" alt="img">\n      ');  } ; __p.push('\n    </div>\n    <div class="user-stats">\n      ');  if(signedIn){ ; __p.push('\n        Add to List:\n        <select class="add-to-lists">\n          <option value=""></option>\n          ');  lists.each( function (list){ ; __p.push('\n            ');  var listsCID = list.listitems().pluck('cocktail_id') ; __p.push('\n            <option value="',  list.get('name') ,'" ',  _.indexOf(listsCID, cocktail.id) > -1 ? "selected" : ""  ,' >',  list.get('name') ,'</option>\n          ');  }); ; __p.push('\n        </select>\n        <div class="flash"></div>\n      ');  } else { ; __p.push('\n        <p><a href="#session/new">Log in</a> to add to lists!</p>\n      ');  } ; __p.push('\n    </div>\n    <h3>at ',  cocktail.bar().name ,'</h3>\n\n    <h2>',  cocktail.escape('liquor') ,'</h2>\n\n    <p>Average Rating: ',  ratingAvg ,'\n    <span class="subtext">(',  cocktail.ratings().length ,' vote',  cocktail.ratings().length !== 1 ? "s" : "" ,')</span></p>\n\n    <h3>Ingredients:</h3>\n    <ul>\n      ');  cocktail.escape('ingredients').split(',').forEach( function(el){ ; __p.push('\n        <li>',  el ,'</li>\n      ');  }); ; __p.push('\n    </ul>\n  </div>\n\n  <h1 class="header-box">My Rating</h1>\n  <div class="box" id="rating-form">\n  </div>\n\n  <h1 class="header-box">Ratings</h1>\n  <div id="reviews">\n  </div>\n\n</div>\n\n<div class="rule-right"></div>\n\n<div class="right bar">\n  ',  JST['cocktails/_rSide']({bar: cocktail.bar(), cId: cocktail.id, similarCocktail: similarCocktail}) ,'\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["feed/_feed"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="box">\n  ');  var splitData = feedItem.get('data').split("; ") ; __p.push('\n  <h2>',  feedItem.escape('username') ,' ',  feedItem.escape('activity') ,'\n    ');  if(feedItem.escape('activity') === 'rated'){ ; __p.push('\n      ',  splitData[2] ,' stars\n    ');  } else if(feedItem.escape('activity') === 'listed'){ ; __p.push('\n      in "',  splitData[2] ,'"\n    ');  }; ; __p.push('  \n  </h2>\n  <h1 class="header-box"><a href="#cocktails/',  feedItem.escape('cocktail_id') ,'">',  feedItem.escape('cocktailName') ,'</a>\n    ');  if(feedItem.get('cocktailPic') !== 'placeholder.png'){ ; __p.push('\n      ');  if(feedItem.get('cocktailPic').indexOf('queensparkswizzle') > -1){ ; __p.push('\n          <img class="feed-img" src="https://s3.amazonaws.com/cocktailist-pro/cocktails/imgs/000/000/008/small/queensparkswizzle.jpg" alt="pic">\n      ');  } else { ; __p.push('\n        <img class="feed-img" src="',  feedItem.get('cocktailPic') ,'" alt="pic">\n      ');  }; ; __p.push('\n    ');  } ; __p.push('\n  </h1>\n  <h3>at ',  splitData[1] ,'</h3>\n  <p>',  splitData[0] ,'</p>\n  <p class="subtext">@ ',  feedItem.escape('time') ,'</p>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["feed/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="left wide">\n  ');  feedItems.each(function (feedItem){ ; __p.push('\n    ',  JST['feed/_feed']({feedItem: feedItem}) ,'\n  ');  }); ; __p.push('\n</div>\n\n<div class="rule-right"></div>\n\n<div class="right bar">\n  <div class="box">\n    <h1><a href="javascript:void(0);" class="addEntry">Add Entry</a></h1>\n  </div>\n  <div class="box">\n    <h1>My Lists</h1>\n    <ul class="filter-list">\n    ');  lists.each( function (list){ ; __p.push('\n      <li><a href="#lists/',  list.id ,'" class="filter-link" >',  list.escape('name') ,' (',  list.escape('listlength') ,')</a></li>\n    ');  }); ; __p.push('\n    </ul>\n  </div>\n  <div class="box">\n    <h1>Today\'s Drink</h1>\n    ');  if(randomCocktail){ ; __p.push('\n    <ul class="category-show-list clearfix">\n      ',  JST['cocktails/_categoryShowItem']({cocktail: randomCocktail, standalone: true}) ,'\n    </ul>\n    <p><a href="#browse/liquor/',  randomCocktail.escape('liquor') ,'">Browse ',  randomCocktail.escape('liquor') ,' drinks</a></p>\n    ');  }; ; __p.push('\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["lists/_side"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('  ');  lists.each( function (list){ ; __p.push('\n    <li><a href="javascript:void(0);" data-list="',  list.id ,'" class="filter-link ',  listShowId === list.id ? 'bolded' : '' ,'" >',  list.escape('name') ,'</a> <a href="javascript:void(0);" class="remove-list" data-list="',  list.id ,'">x</a></li>\n  ');  }); ; __p.push('\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["lists/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="box">\n  <h1>Add List</h1>\n  <form>\n    <label for="name">Name</label>\n    <input type="text" value="',  list.escape('name') ,'" name="list[name]" id="name">\n    <button>Save</button>\n  </form>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["lists/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="left bar">\n  <div class="box">\n    <h1><a href="javascript: void(0);" id="add-list">Create List</a></h1>\n  </div>\n\n  <div class="box">\n    <h1>Your Lists</h1>\n    <ul class="filter-list">\n\n    </ul>\n    <p class="subtext">(double click to edit name)</p>\n  </div>\n</div>\n\n<div class="rule-left"></div>\n\n<div class="right wide">\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["lists/listitemIndex"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>',  list.escape('name') ,'</h1>\n');  if(listitems.length > 0){ ; __p.push('\n  ');  listitems.forEach( function (listitem){; __p.push('\n    <div class="box">\n      <a href="javascript:void(0);" class="remove-item" data-listitem="',  listitem.id ,'">x</a>\n      <h1 class="header-box"><a href="#cocktails/',  listitem.get('cocktail_id') ,'">',  listitem.get('cocktail').name ,'</a></h1>\n      <h3>',  listitem.get('cocktail').bar.name ,'</h3>\n      <p class="subtext">Added on ',  listitem.get('time') ,'</p>\n    </div>\n  ');  }); ; __p.push('\n');  } else { ; __p.push('\n  <h2>This list is empty!</h2>\n');  }; ; __p.push('\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["ratings/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form>\n  ');  if(!rating.isNew()){ ; __p.push('\n    <p>You reviewed this on ',  rating.escape('time') ,'. Feel free to edit it below!</p>\n  ');  } ; __p.push('\n  <label for="rating">Rating</label>\n    ');  for(var i = 1; i<=5; i++){ ; __p.push('\n      <label class="radio">\n      <input type="radio" name="rating[rating_num]" value="',  i ,'"\n      ');  if(rating.get('rating') === i){ ; __p.push('\n        checked\n      ');  } ; __p.push('\n      > ',  i ,'\n      </label>\n    ');  }; ; __p.push('\n\n  <label for="body">Review</label>\n  <textarea name="rating[body]" placeholder="comments (optional)">',  rating.escape('body') ,'</textarea>\n  <ul id="errors"></ul>\n  <button class="submitRating">submit</button>\n\n  ');  if(!rating.isNew()){ ; __p.push('\n    <a href="javascript: void(0);" class="subtext" id="delete-rating">Delete Rating</a>\n  ');  } ; __p.push('\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["ratings/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="box">\n  <h2>',  rating.escape('username') ,' rated it ',  rating.escape('rating') ,' stars</h2>\n  <p>',  rating.escape('body') ,'</p>\n  <p class="subtext">on ',  rating.escape('time') ,'</p>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["search"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="left wide">\n  <h1>Search Results</h1>\n  <input class="q" type="text">\n  ');  if(!_.isEmpty(resultGroups)){ ; __p.push('\n\n    ');  for(group in resultGroups){ ; __p.push('\n      <h1>',  group ,'</h1>\n      ');  resultGroups[group].forEach( function (result){; __p.push('\n        <div class="box">\n\n          ');  var type = result.get('_type') ; __p.push('\n          <h2>\n            ');  if(type==="Bar"){ ; __p.push('\n              <a href="#browse/bar/',  result.escape('name') ,'">',  result.escape('name')  ,'</a>\n            ');  } else if(type==="User"){ ; __p.push('\n              ',  result.get('username')  ,'\n            ');  } else { ; __p.push('\n              <a href="#cocktails/',  result.id ,'">',  result.escape('name')  ,'</a>\n            ');  }; ; __p.push('\n          </h2>\n          <p class="subtext">\n            ');  if(type==="Bar"){ ; __p.push('\n              ',  result.get('address') ,'\n            ');  } else if(type==="User"){ ; __p.push('\n              Member since ',  result.get('created_at') ,'\n            ');  } else { ; __p.push('\n              ',  result.get('ingredients') ,'\n            ');  }; ; __p.push('\n          </p>\n        </div>\n      ');  }); ; __p.push('\n    ');  } ; __p.push('\n  ');  } else { ; __p.push('\n    <h3>No results to display</h3>\n  ');  } ; __p.push('\n</div>\n\n<div class="rule-right"></div>\n\n<div class="right bar">\n  <div class="box">\n    <h1>Results</h1>\n    <ul class="filter-list">\n      ');  for(group in resultGroups){  ; __p.push('\n        <li><strong>',  group ,'</strong> (',  resultGroups[group].length ,')</li>\n      ');  }; ; __p.push('\n    </ul>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["shared/nav"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<li><a href="" ',  !currentUser.isSignedIn() ? "class=grayed" : "" ,' ',  section==="feed" ? "class=active" : "" ,' >Feed</a></li>\n<li><a href="#lists" ',  !currentUser.isSignedIn() ? "class=grayed" : "" ,' ',  section==="lists" ? "class=active" : "" ,' >My Lists</a></li>\n<li><a href="#browse" ',  section==="browse" ? "class=active" : "" ,'>Browse</a></li>\n<li><a href="" class="grayed" >Recommendations</a></li>\n<li><a href="#cocktails/new" ',  !currentUser.isSignedIn() ? "class=grayed" : "" ,' ',  section==="form" ? "class=active" : "" ,' >Add Entry</a></li>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["shared/searchbox"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<input type="text" class="header-search" placeholder="search">\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["shared/signIn"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="signinbox" ',  displayed ? "" : "class='exit'" ,' >\n  <h1>Log In</h1>\n  <p>Don\'t have an account? <a href="#users/new" class="switch">Sign up.</a></p>\n  <form>\n    <input type="text" placeholder="email" name="user[email]">\n    <input type="password" placeholder="password" name="user[password]">\n    <button>Log In</button>\n    <a href="/auth/facebook" class="button-link">Facebook Login</a>\n  </form>\n  <div class="flashbox">\n    <p class="subtext">Can use guest accounts of <strong>guest@aa.io</strong>, <strong>guest2@aa.io</strong>, <strong>guest3@aa.io</strong>, <strong>guest4@aa.io</strong>.\n      Take your pick! Password is "password".</p>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["shared/userForm"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="signinbox" ',  displayed ? "" : "class='exit'" ,' >\n  <h1>Create an Account</h1>\n  <p>Already have an account? <a href="#session/new" class="login">Log in.</a></p>\n\n  <form>\n    <input type="text" placeholder="username" name="user[username]">\n    <input type="text" placeholder="email" name="user[email]">\n    <input type="password" placeholder="password" name="user[password]">\n    <button>Sign Up</button>\n  </form>\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["shared/userMenu"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');  if(currentUser.isSignedIn()){; __p.push('\n  <li>Logged in as ',  currentUser.username() ,'</li>\n  <li><a href="javascript: void(0);" id="logout-link">Log out</a></li>\n');  } else { ; __p.push('\n  <li><a href="#session/new">Log In</a></li>\n');  }; ; __p.push('\n');}return __p.join('');};
}).call(this);
...
Cocktailist.Collections.Cocktails = Backbone.BetterCollection.extend({
  url: 'api/cocktails/',
  model: Cocktailist.Models.Cocktail
});
Cocktailist.Collections.FeedItems = Backbone.BetterCollection.extend({
