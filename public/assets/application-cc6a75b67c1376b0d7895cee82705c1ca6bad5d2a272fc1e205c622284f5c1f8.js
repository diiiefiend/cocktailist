...
(function() { this.JST || (this.JST = {}); this.JST["feed/_rSide"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('  <div class="box">\n    <h1><a href="javascript:void(0);" class="addEntry">Add Entry</a></h1>\n  </div>\n  <div class="box">\n    <h1>My Lists</h1>\n    <p>(placeholder for my lists subview)</p>\n  </div>\n  <div class="box">\n    <h1>Random Browse</h1>\n    <p>(placeholder for browse subview)</p>\n  </div>\n');}return __p.join('');};
}).call(this);
