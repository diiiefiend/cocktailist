...
Feed.create(user_id: 1, cocktail_id: 1, activity: 'added', data: 'test test; Pouring Ribbons')
Feed.create(user_id: 1, cocktail_id: 2, activity: 'added', data: 'test test; Pouring Ribbons')
Feed.create(user_id: 1, cocktail_id: 3, activity: 'added', data: 'test test; Pouring Ribbons')
Feed.create(user_id: 1, cocktail_id: 4, activity: 'added', data: 'test test; Pouring Ribbons')
