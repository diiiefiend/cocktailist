...
Feed.create(user_id: 1, cocktail_id: 1, activity: 'added')
Feed.create(user_id: 1, cocktail_id: 2, activity: 'added')
Feed.create(user_id: 1, cocktail_id: 3, activity: 'added')
Feed.create(user_id: 1, cocktail_id: 4, activity: 'added')
